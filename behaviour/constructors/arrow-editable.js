define(["helpers"],
	function(h){
		return function(EndPoint,ControlPoint,hookElementEventsToStatechart){
				...
				showControlPoints : function(){
					...
					for(var i=0; i < numItems; i++){
						...
						if(nextPathSeg && nextPathSeg.x1 !== undefined){
							cp1 = ControlPoint(nextPathSeg,1,endPoint);
						}

						if(pathSeg.x2 !== undefined){ 
							cp2 = ControlPoint(pathSeg,2,endPoint,cp1);
						}
