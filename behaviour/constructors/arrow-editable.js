 ...
 **/
define(['helpers', 'icons/end-point', 'icons/control-point'], function (
	h,
	EndPoint,
	ControlPoint
) {
	let setupArrowEditorBehaviourAPI = {
		showControlPoints: function () {
			...
			let numItems = this.path.pathSegList.numberOfItems;
			for (let i = 0; i < numItems; i++) {
				let nextPathSeg, cp1, cp2, endPoint;
